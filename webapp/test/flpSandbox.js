		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employe Deatails",
									"targetURL": "#idemployereadtwoentitys-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idemployereadtwoentitys-display": {
								"semanticObject": "idemployereadtwoentitys",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idemploye.readtwoentitys",
									"url": sap.ui.require.toUrl("idemploye/readtwoentitys")
								}
							}
						}
					}
